package com.service.unified_development_power_platform.Infraestructure.Domain;
...
@PropertySources({ @PropertySource(value = "classpath:swagger.yml", factory = YamlSourceFactory.class) })
